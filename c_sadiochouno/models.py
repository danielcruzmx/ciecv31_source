...
class Condomino(models.Model):
    ...
    def cargos(self):
        return mark_safe('<a href="/admin/c_sadiochouno/asiento/?condomino__id__exact=%d">Cargos view</a>' % (self.id))

    #http://127.0.0.1:8000/admin/c_olimpo/movimiento/?condomino__id__exact=10

    def depositos(self):
        return mark_safe('<a href="/admin/c_sadiochouno/movimiento/?condomino__id__exact=%d">Depositos view</a>' % (self.id))
...
class DetalleMovimiento(models.Model):
    ...
    descripcion = models.CharField(max_length=250, blank=True, null=True, default = '.')
    #descripcion = models.CharField(max_length=250, blank=True, null=True)
    ...
    proveedor = models.ForeignKey(Proveedore, verbose_name = ('Proveedor'), on_delete = models.CASCADE, related_name='sadiochouno_prov_detalle')
